"""
InDhan Portal management command to create a new user and associated employee.
"""
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            bot = User.objects.filter(username="InDhan Portal Bot").first()
            if bot is None:
                User.objects.create_user(
                    username="InDhan Portal Bot",
